...
const Nav = () => {
	...
	return (
		<div className={`nav ${isScrolled && "nav_black"} `}>
			<svg className="nav_logo" xmlns="http://www.w3.org/2000/svg" height={800} width={1200} viewBox="-153.6 -69.1855 1331.2 415.113">
				<path
					fill="#d81f26"
