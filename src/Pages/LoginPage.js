	...
	return (
		<div className="loginscreen">
			<div className="loginscreen_bg">
				<svg className="loginscreen_logo" xmlns="http://www.w3.org/2000/svg" height={800} width={1200} viewBox="-153.6 -69.1855 1331.2 415.113">
					<path
						fill="#d81f26"
				...
				<button onClick={() => setToggleSignIn(true)} className="loginscreen_btn">
					Sign in
				</button>
				...
				{toggleSignIn ? (
					...
					<>
						...
						<form className="loginscreen_form">
							...
							<button onClick={() => setToggleSignIn(true)} className="form_btn">
								Get Started
							</button>
						</form>
					</>
